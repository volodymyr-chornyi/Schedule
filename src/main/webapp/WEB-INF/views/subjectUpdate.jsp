<jsp:useBean id="subject" scope="request" type="com.softserveacademy.model.Subject"/>
<%@ taglib uri = "http://java.sun.com/jsp/jstl/core" prefix = "c" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<html>
<head>
    <title>subjectUpdate</title>
...
<body>
    ...
    <h1 class="form-style-2-heading">Сhange subject data</h1>
    <form action="${pageContext.request.contextPath}/subject" method="post">
        <table>
            ...
            <tr>
                <th>name:</th>
                <td>
                    <input type="text" required pattern="^[a-zA-Z0-9]{2,}\'?-?" name="name" value="${subject.name}">
                </td>
            </tr>
            <tr>
                <th>teachers:</th>
                <td>
                    ...
                    ${subject.teachersToString}
                </td>
            </tr>
            <tr>
                <td>
                    <a href="${pageContext.request.contextPath}/subjectlist">Close</a>
                </td>
                <td>
